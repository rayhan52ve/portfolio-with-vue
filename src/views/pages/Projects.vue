        ...
        <section class="grid-wrap">
          <ul class="row grid">
            ...
            <li>
              <figure>
                <img
                  src="/frontend/img/projects/project-1.jpg"
                  alt="Portolio Image"
                />
            ...
            <li>
              <figure>
                <img
                  src="/frontend/img/projects/project-2.jpg"
                  alt="Portolio Image"
                />
            ...
            <li>
              <figure>
                <img
                  src="/frontend/img/projects/project-3.jpg"
                  alt="Portolio Image"
                />
            ...
            <li>
              <figure>
                <img
                  src="/frontend/img/projects/project-4.jpg"
                  alt="Portolio Image"
                />
            ...
            <li>
              <figure>
                <img
                  src="/frontend/img/projects/project-5.jpg"
                  alt="Portolio Image"
                />
                <div><span>Image Project</span></div>
              </figure>
            ...
            <li>
              <figure>
                <img
                  src="/frontend/img/projects/project-6.jpg"
                  alt="Portolio Image"
                />
                <div><span>Image Project</span></div>
              </figure>
            ...
            <li>
              <figure>
                <img
                  src="/frontend/img/projects/project-7.jpg"
                  alt="Portolio Image"
                />
                <div><span>Image Project</span></div>
              </figure>
            ...
            <li>
              <figure>
                <img
                  src="/frontend/img/projects/project-8.jpg"
                  alt="Portolio Image"
                />
                <div><span>Image Project</span></div>
              </figure>
            ...
            <li>
              <figure>
                <img
                  src="/frontend/img/projects/project-9.jpg"
                  alt="Portolio Image"
                />
                <div><span>Image Project</span></div>
              </figure>
        ...
        <section class="slideshow">
                ...
                <figcaption>
                  ...
                  <div class="row open-sans-font">
                    ...
                    <div class="col-6 mb-2">
                      ...
                      ><span class="project-label">Preview </span>:
                      <span class="ft-wt-600 uppercase"
                        ><a href="#" target="_blank">www.videohive.net</a></span
                      >
                    </div>
                  </div>
                </figcaption>
            ...
            <li>
              <figure>
                ...
                <video
                  ...
                  controls
                  poster="/frontend/img/projects/project-1.jpg"
                >
                  <source
                    src="/frontend/img/projects/video.mp4"
                    type="video/mp4"
                  />
                </video>
                <!-- Main Project Content Ends -->
          ...
          <nav>
            <span class="icon nav-prev"
              ><img
                src="/frontend/img/projects/navigation/left-arrow.png"
                alt="previous"
            /></span>
            <span class="icon nav-next"
              ><img
                src="/frontend/img/projects/navigation/right-arrow.png"
                alt="next"
            /></span>
            <span class="nav-close"
              ><img
                src="/frontend/img/projects/navigation/close-button.png"
                alt="close"
              />
            </span>
          </nav>
...
export default {
  ...
  computed: {
    transitionCSS() {
      return `all ${this.speed}ms ${this.easing}`;
    },
  },
  mounted() {
    this.$nextTick(() => {
  ...
  methods: {
    initializeJQueryEvents() {
      $(".slideshow nav span").on("click", this.stopVideos);
      ...
      $(".nav-prev, .nav-next").on("click", this.toggleHeaderOnNav);
      $(".grid li figure").each((_, el) => {
        $(el).hoverdir();
      });
    },
    ...
    stopVideos() {
      ...
      const youtubeVideo = $(".youtube-video")[0];
      if (youtubeVideo) {
    ...
    toggleHeaderOnNav() {
      if (
        $(".slideshow ul li:first-child").hasClass("current") ||
        $(".slideshow ul li:last-child").hasClass("current")
      ) {
        $("#navbar-collapse-toggle").removeClass("hide-header");
      } else {
        $("#navbar-collapse-toggle").addClass("hide-header");
    ...
    handleMouseEnter(event) {
      this.transitionProp = this.transitionCSS;

      clearTimeout(this.hoverTimeout);
      this.hoverTimeout = setTimeout(() => {
        const direction = this.getDirection(event);
        this.hoverStyle = this.getHoverStyle(direction).to;
      }, this.hoverDelay);
    },
    ...
    handleMouseLeave(event) {
      clearTimeout(this.hoverTimeout);
      const direction = this.getDirection(event);
      this.hoverStyle = this.getHoverStyle(direction).from;
    },
    ...
    getHoverStyle(direction) {
      ...
      switch (direction) {
        case 0:
          fromStyle = !this.inverse ? slideFromTop : slideFromBottom;
          toStyle = slideTop;
          break;
        case 1:
          fromStyle = !this.inverse ? slideFromRight : slideFromLeft;
          toStyle = slideLeft;
          break;
        case 2:
          fromStyle = !this.inverse ? slideFromBottom : slideFromTop;
          toStyle = slideTop;
          break;
        case 3:
          fromStyle = !this.inverse ? slideFromLeft : slideFromRight;
          toStyle = slideLeft;
          break;
      }
